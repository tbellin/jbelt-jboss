...
public class ApplicationInitializer {
    ...
    private final List<org.jboss.seam.examples.booking.model.User> users = new ArrayList<User>();
    private final List<org.jboss.seam.examples.booking.model.Hotel> hotels = new ArrayList<Hotel>();
    ...
    public void importData(@Observes @Initialized WebApplication webapp) {
        log.info("Importing seed data for application " + webapp.getName() + webapp.getContextPath());
    ...
    private int numUsers() {
        ...
        log.info("Found {0} user(s)",results.size(), null, null);	
    ...
    private int numHotels() {
        ...
        List<User> results = query.getResultList();
        log.info("Found {0} hotel(s)",results.size(), null, null);	
